    ...
    public class TutorialProjectSettings : ScriptableObject
    {
        ...
        public static TutorialProjectSettings Instance
        {
            get
            {
                if (s_Instance == null)
                {
                    IEnumerable<TutorialProjectSettings> settings = TutorialEditorUtils.FindAssets<TutorialProjectSettings>();
                    if (!settings.Any())
                    {
                    ...
                    {
                        TutorialProjectSettings setting = settings.First();
                        if (settings.Count() > 1)
                        {
        ...
        private static TutorialProjectSettings s_Instance;
        ...
        private SceneAsset m_InitialScene;
        ...
        private TutorialStyles m_TutorialStyle;

        internal static readonly string k_DefaultStyleAsset = "Packages/com.unity.learn.iet-framework/DefaultAssets/Tutorial Styles.asset";
        ...
        private bool m_RestoreAssetsBackupOnTutorialReload;
        ...
        private string m_ReportUrl = "https://discussions.unity.com/c/learn/50";
        ...
        private bool m_AppendDataToReport;
