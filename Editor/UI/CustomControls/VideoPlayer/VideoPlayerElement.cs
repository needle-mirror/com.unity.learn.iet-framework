...
namespace Unity.Tutorials.Editor
{
    ...
    public partial class VideoPlayerElement : VisualElement
    {
        ...
        // in a loop.
        private static Queue<VideoPlayer> s_VideoPlayerPool = new();
        ...
        private void PreparePlayer()
        {
            ...
            if (s_VideoPlayerPool.TryDequeue(out UnityEngine.Video.VideoPlayer player))
            {
            ...
            else
            {
                ...
                m_VideoPlayer = m_PlaybackObject.AddComponent<UnityEngine.Video.VideoPlayer>();
        ...
        private void OnAttachedToPanel(AttachToPanelEvent evt)
        {
            ...
            // TODO: Note: All these Q<> fail when the component is seen in the UI Builder's Library (so it's very low-priority)
            ...
            m_SpeedSelectionRoot.RegisterCallback<MouseLeaveEvent>(_ =>
            {
            ...
            List<VisualElement> children = m_SpeedSelectorPopup.Query<VisualElement>(className: "video-speed-label-container").Build().ToList();
        ...
        private void PreparedHandler(UnityEngine.Video.VideoPlayer source)
        {
        ...
        private void FrameReadyHandler(UnityEngine.Video.VideoPlayer player, long frameIdx)
        {
            MarkDirtyRepaint();
        ...
        {
            UnityEngine.Video.VideoPlayer player = m_VideoPlayer;
